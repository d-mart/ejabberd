...
\begin{description}
  \titem{\texttt{ejabberd\_c2s}}
    ...
    \texttt{starttls}, \texttt{starttls\_required}, \texttt{peer\_cert\_required}, \texttt{tls},
    \texttt{zlib}
...
\begin{description}
  ...
  \titem{starttls\_required} \ind{options!starttls\_required}This option
    ...
    You should also set the \option{certfile} option.
    You can define a certificate file for a specific domain using the global option \option{domain\_certfile}.
  \titem{peer\_cert\_required} \ind{options!peer\_cert\_required}This option specifies that the peer
    must supply a valid certificate.  Setting \option{peer\_cert\_required} also sets \option{starttls\_required}.
